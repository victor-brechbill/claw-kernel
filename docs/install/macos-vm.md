---
summary: "Run OpenClaw in a sandboxed macOS VM (local or hosted) when you need isolation or BlueBubbles"
read_when:
  - You want OpenClaw isolated from your main macOS environment
  - You want BlueBubbles integration in a sandbox
...
Use a macOS VM when you specifically need macOS-only capabilities (BlueBubbles) or want strict isolation from your daily Mac.
...
- BlueBubbles support (impossible on Linux/Windows)
...
2. Skip Apple ID (or sign in later)
