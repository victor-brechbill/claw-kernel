...
- Values: `whatsapp|telegram|discord|slack|signal` (Mattermost requires plugin)
...
- `send`
  - Channels: WhatsApp/Telegram/Discord/Slack/Signal/MS Teams
...
- `poll`
  - Channels: WhatsApp/Telegram/Discord/MS Teams
