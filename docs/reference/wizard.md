...
<Steps>
  ...
  <Step title="Channels">
    ...
    - [BlueBubbles](/channels/bluebubbles): server URL + password + webhook.
...
- Channel allowlists (Slack/Discord/Microsoft Teams) when you opt in during the prompts (names resolve to IDs when possible).
...
- Providers: [WhatsApp](/channels/whatsapp), [Telegram](/channels/telegram), [Discord](/channels/discord), [Signal](/channels/signal), [BlueBubbles](/channels/bluebubbles)
